...
static void parse_note(CHAR_DATA *ch, char *argument, int type);
...
static void load_thread(char *name, NOTE_DATA **list, int type, time_t free_time)
{
    ...
    bug_area("Load_notes: bad key word.", 0, fp, NOTE_FILE);
    exit(1);
    return;
}
...
static void note_remove(CHAR_DATA *ch, NOTE_DATA *pnote, bool delete)
{
